...
export const tasksSlice = createSlice({
  ...
  reducers: {
    ...
    builder.addCase(updateTask.rejected, (state, action) => {
      state.loading = 'failed';
      state.error = action.error.message || 'Failed toggle task';
    })
...
export const { selectTasksLoading, selectTasks, selectTotalTasks, selectCurrentTask, selectCurrentTaskLoading } = tasksSlice.selectors
